                    ...
                    <div class="card card-widget widget-user-2">
                        <div class="widget-user-header bg-navy">
                            <div class="widget-user-image">
                                <img class="img-circle elevation-2" style="width: 100px; height: 100px;" src="public/lte/dist/img/user.jpg" alt="User Avatar">
                            </div>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                     @for ($i = 1; $i <= 14; $i++)
                        ...
                        <button type="button" class="btn btn-primary btn-lg mr-3" data-toggle="modal"
                                data-target="#smt-{{ $i }}" style="width: 207px; height: 75px;" @if ($i <= $mahasiswa->hitungSemester()) enabled @else disabled @endif>
                            Semester {{ $i }}
                        </button>
