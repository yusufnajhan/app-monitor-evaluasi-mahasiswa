            ...
            <div class="container">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Rekap Skripsi</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->

                <h1 class="m-0">Rekap Skripsi per Tahun</h1>
                <br>
                ...
                <div class="card card-primary">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @for ($year = now()->year - 6; $year <= now()->year; $year++)
                                        <td>
                                            <a href="/departemen/mahasiswa-sudah-skripsi/{{ $year }}">
                                                {{ $skripsi->sudahSkripsi($year) }}
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/departemen/mahasiswa-belum-skripsi/{{ $year }}">
                                                {{ $skripsi->belumSkripsi($year) }}
                                            </a>
                                        </td>
                                    @endfor
                                </tr>
                    ...
                    <div class="card-footer">
                        <a href="/departemen/cetak-pdf-skripsi" class="btn btn-primary">
                            Cetak PDF
                        </a>
                    </div>
                    <!-- /.card-header -->
